...
public class GUI {
	...
	public static JFrame setFrame(JFrame f,String title,Dimension size,LayoutManager layout,boolean resizable,boolean exitOnClose) {
		f = new JFrame(title);
		f.setResizable(resizable);
		f.setSize(size.width,size.height);
		if(exitOnClose) {f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);}
	...
	public static JLabel setLabel(String text,Font font,Color col) {
		JLabel l = new JLabel();
		l.setText(text);
		l.setFont(font);
		l.setForeground(col);
